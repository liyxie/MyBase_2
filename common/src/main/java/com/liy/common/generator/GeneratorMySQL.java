package com.liy.common.generator;
...
//    public static final String SAVE_PATH = System.getProperty("user.dir") + "/src/main/java";
    public static final String SAVE_PATH = "common/src/main/java";
    /**
     * xml保存目录
     */
    public static final String XML_SAVE_PATH ="common/src/main/java/com/liy/common/generator/new/xml";
    /**
     * 保存到包下面
     */
    public static final String PACKAGE = "com.liy.common.generator.new.java";
    /**
     * 要生成的表
     */
...
//                        .addFieldPrefix("sys_") // 增加过滤字段前缀
                        ...
                        .formatFileName("%sBo") // Entity 文件名称
